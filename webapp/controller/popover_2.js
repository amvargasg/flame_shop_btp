sap.ui.define([
	...
	return ManagedObject.extend("com.sap.build.standard.manageProducts.controller.popover_2", {
		constructor: function(oView) {
			this._oView = oView;
			this._oControl = sap.ui.xmlfragment(oView.getId(), "com.sap.build.standard.manageProducts.view.popover_2", this);
			this._bInit = false;
		},
		...
		_onSearchFieldLiveChange: function(oEvent) {
			var sControlId = "sap_m_Popover_4-content-sap_m_List-1489998633213";
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "sap_m_Popover_4-content-sap_m_List-1489998633213",
				"groups": ["items"]
			}];
